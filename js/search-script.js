/*!
  ...
  */
!function()
{"use strict";var o={compile:
	function M(r){
		return i.template.replace(i.pattern,
		function(t,e){
			var n=i.middleware(e,r[e],i.template);
			return void 0!==n?n:r[e]||t})},setOptions:
	function T(t){i.pattern=t.pattern||i.pattern,i.template=t.template||i.template,"function"==typeof t.middleware&&(i.middleware=t.middleware)}},i={};
	i.pattern=/\{(.*?)\}/g,i.template="",
	...
	var r=new function R(){
		this.matches=function(e,t){
			return!!e&&(e=e.trim().toLowerCase(),(t=t.trim().toLowerCase()).split(" ").filter(
				function(t){
		...
		search:function N(t){
			return t?function a(t,e,n,r){
				...
				setOptions:function E(t){
					...
					function d(t,e,n,r)
					{
						for(var i in t)if(!h(t[i],r.exclude)&&n.matches(t[i],e))
							return t
					}
					function h(t,e)
					{
					...
					var m={
						...
						var t=function H(t){
							if(!function e(t){
								...
								var r=t.required;this.getRequiredOptions=
								function(){return r},
							...
							v={
								...
								function S(t){
									u.put(t),
									function e(){
										y.searchInput.addEventListener("keyup",
											function(t){
												!function e(t){
							...
							function C(t){
								...
								w=window,
								y={
									searchInput:null,resultsContainer:null,json:[],success:Function.prototype,searchResultTemplate:'<ul><a class="post-title-link" href="{url}" title="{desc}">{title}</a></ul>',templateMiddleware:Function.prototype,sortMiddleware:
									function(){
										return 0
										},
									...
									z=function(t){
										return 0<O.validate(t).length&&L("You must specify the following required options: "+g),
										y=v.merge(y,t),o.setOptions({
											template:y.searchResultTemplate,middleware:y.templateMiddleware
										}),
										u.setOptions({
											fuzzy:y.fuzzy,limit:y.limit,sort:y.sortMiddleware
										}),
										(v.isJSON(y.json)?S:
											function e(n){
